...
//(1) 查询表中所有数据查询条件
var QUERY_DATAS_WHERE = (tableName, column) => `SELECT * FROM ${tableName} WHERE ${column} = ?`
//(2) 插入数据(全部列)
...
var INSERT_DATAS_BY_OBJECT = (tableName) =>
  `INSERT INTO ${tableName} SET ?`;
//(4) 删除数据(根据id)
var DELETE_DATA_BY_ID = (tableName) =>
...
var UPDATE_DATAS_BY_OBJECT = (tableName) =>
...
module.exports = {
  ...
  INSERT_DATAS,
  INSERT_DATA,
  INSERT_DATAS_BY_OBJECT,
  UPDATE_DATAS_BY_OBJECT,
  DELETE_DATA_BY_ID,
  DELETE_DATAS,
  UPDATE_DATA,
};